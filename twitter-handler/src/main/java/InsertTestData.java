...
public class InsertTestData {
    ...
    public Map<String, ArrayList<String>> getTestUsers() {
        ...
        users.put("Bots", utilities.fileToArray("botlist.txt"));
        users.put("Non-Bots", utilities.fileToArray("remainingnonbots.txt"));
...
//                ArrayList<JSONObject> tweets = getTweetObjects.getTweetsFromUser(1000, bot);
//
...
//        }
        ...
        for (String nonbot : nonbots) {
            ArrayList<JSONObject> tweets = getTweetObjects.getTweetsFromUser(1000, nonbot);
